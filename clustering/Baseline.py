...
if clustering:
    ...
    _, leven_cluster = dbscan(X, metric=lev_metric, eps=1, min_samples=5, n_jobs=-1)
    np.savetxt('db_cluster_levestein_5.txt', leven_cluster, delimiter=',')
else:
    leven_cluster = np.loadtxt("../aida-yago2-dataset/db_cluster_levestein_5.txt", dtype=np.int32)
#%%
